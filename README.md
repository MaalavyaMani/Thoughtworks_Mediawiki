...
This repo contains the infrastructure and automation scripts of media wiiki application
The following was used to automate this application : Terraform for creating Azure Kuberenetes Services(AKS), Helm for deploying the application in AKS
...
we can view logs in log analytics space 
...
<img src="images/resources.png">
 ...
 we can see the logs in log analytic workspace
 ...
 <img src="images/media_wiki_running.png" width="700" height="500" style="vertical-align:middle">
